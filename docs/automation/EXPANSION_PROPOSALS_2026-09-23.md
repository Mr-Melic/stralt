# Stralt expansion catalog — 2026-09-23

**Author:** Expansion Director (cron `0 */24 * * *`, automation `3f31b18f-a492-11f1-a7d1-d6b4613131ce`)  
**This run:** sixth catalog. Re-rank against `origin/main` `0f5363f` (`Merge pull request #332` — accepted-challenge HUD). Author-date on that tip is **2026-09-03**. Calendar: 2026-09-23.  
**Prior living catalog on `main`:** [`EXPANSION_PROPOSALS_2026-09-02.md`](./EXPANSION_PROPOSALS_2026-09-02.md) (`HEAD` then `58302bc`).  
**Unmerged sibling catalogs:** PR **#366** (`EXPANSION_PROPOSALS_2026-09-21.md`) and PR **#397** (`EXPANSION_PROPOSALS_2026-09-22.md`) — same `HEAD`, still drafts. This file **adopts** 019 / 020 / 021 / 022 rather than reminting them.  
...
All seventeen 08-31 / 09-01 / 09-02 cards remain **PROPOSED**. 019–022 remain **PROPOSED**. None shipped. None superseded. New IDs in this file are additive first-ship slices of already-ranked cards.

`README.md` still indexes the 09-01 catalog. Older open **#333** (TBC), **#346** (product-docs sync), and **#420** (docs sync) own that file. This run does not touch `README.md` / `AGENTS.md` / `ARCHITECTURE.md` / `WorldExploration.tsx` / `mapGen.ts` / `challengeCompletion.ts` / the 09-02 catalog (#366) / the 09-22 catalog (#397).
...
`main` did **not** move. #366 and #397 ranked the same `0f5363f`. This run is a re-rank against a still-growing open-PR queue, plus two first-ship slices of 004 and 009 that do not need a new family / spell / Wave-N sheet.
...
| Open queue exploded again | Oldest-first: **#327** Striker AoE (`WX` / targeting / `challengeCompletion`), **#331** portal destack (`mapGen`). Twin **#370** restacks the same Striker gate. Then **#333–#446** from the 09-21 and 09-22 flocks (~120 drafts). Do not restack those files. |
| #366 and #397 still drafts | 09-21 / 09-22 catalogs are not on `main`. Adopt 019–022. Do not fight #366 on `EXPANSION_PROPOSALS_2026-09-02.md` or #397 on the 09-22 file. |
| Blood Moon / Mirror Field are **live** | Unchanged from #397: `spellEngine.ts` **895** Blood Moon ×1.25 player non-heal damage; **901–907** Mirror Field 20% ST reflect. Registry hooks in `mapModifiers.ts` 260–277 remain empty. Gravity Well / Fog of War still unused (`_isGravityWell` / `_isFogOfWar`, `WX` 2324–2326). |
...
| Telemetry still none | TBC #333 / #395: `WAITING_FOR_TELEMETRY`. 0 collectors / 0 rows. Do not claim live demand. Do not retune XP, Doka, or spawn weights. |
| Engineering-health on `main` | Last landed: `MASTER_ROADMAP.md` / LONG_HORIZON / CDA / PXA dated **2026-09-02**. 09-21/09-22 MTD (#338 / #402), CDA (#359 / #403), PX (#343 / #393), LHIPS (#357 / #407) are still drafts. Their code claims that match this `HEAD` are accepted. |
...
| Family still a sticker | `maybeApplyEnemyFamilyVariant` (`spawnPolicy.ts` 279–286) at `WX` 5864. Chassis stays a random chess piece (`WX` 5764–5765). Four mute families. Family HP dies at `calcEnemyMaxHp` (`WX` 11970–11974). |
...
| `worldFeatures` still tests-only | 1913 lines. No WX import. Freeze new `WF-*` rows until one is wired. |
| `combinedMechanic` still copy | `useBossRush.ts` 19–131. Zero engine readers. |
...
| :--- | :--- | :--- |
| [`ENEMY_ELITE_EVOLUTION_2026-08-31.md`](./ENEMY_ELITE_EVOLUTION_2026-08-31.md) | Wave 1 family sheets, variant floors, pack recipes | 001, 002, 004, 014, 021, 023 |
| Wave 2–5 elite / family sheets (09-01 / 09-02 + open **#349** / **#405**) | More family ids | **Hold** until 001/014/018/019/021 exist |
...
| SPELL_PROPOSALS 08-31…09-02 + open **#342** / **#411** | Tactical gap-fill ids | **Hold** until 003 ships |
| [`ENEMY_AI_EVOLUTION.md`](../ENEMY_AI_EVOLUTION.md) + 09-01 / 09-02 + open **#351** / **#416** | Unbounded AI modules | 005 |
| [`BOSS_AND_SPELL_DISCOVERY.md`](../design/BOSS_AND_SPELL_DISCOVERY.md) + open **#367** / **#406** | Boss sheets / Rush Table C–D | 011, 017 |
| ENCOUNTER_EVOLUTION 08-31…09-02 + open **#347** / **#396** | Teach → pressure dungeon beats | 007, 010 |
| [`WORLD_DYNAMICS.md`](../WORLD_DYNAMICS.md) + `engine/worldFeatures.ts` + open **#344** / **#399** | Rarity / relative-difficulty overlay | 009, 016, 022, 024 |
| ENEMY_FORMATIONS 08-31…09-02 + open **#348** / **#401** | Synergy packs | 004, 023 |
| [`MECHANIC_INTERACTION_MATRIX_2026-09-02.md`](./MECHANIC_INTERACTION_MATRIX_2026-09-02.md) + open **#336** / **#410** | Live join gaps | 013, 018, 024 |
| [`MASTER_ROADMAP.md`](./MASTER_ROADMAP.md) (on `main`: 09-02) + open **#338** / **#402** | P0 integrity before expansion PRs | Process, not content |
| [`PX_COHERENCE_AUDIT_2026-09-02.md`](./PX_COHERENCE_AUDIT_2026-09-02.md) + open **#343** / **#393** | Register / modifier / discovery honesty | 014 QA; Register is lore |
| [`LONG_HORIZON_2026-09-02.md`](./LONG_HORIZON_2026-09-02.md) + open **#357** / **#407** | XP wall; kit NaN; summoner saturate | PREREQ-A/B/C; do not retune curve |
| [`CONTENT_DIVERSITY_AUDIT_2026-09-02.md`](./CONTENT_DIVERSITY_AUDIT_2026-09-02.md) + open **#359** / **#403** | Live spawn is sticker + NaN kits; Blood Moon live | Confirms 001/014/019/021/022/023 |
| [`TELEMETRY_BALANCE_2026-09-02.md`](./TELEMETRY_BALANCE_2026-09-02.md) + open **#333** / **#395** | STATUS WAITING_FOR_TELEMETRY | No demand claims |
...
| PREREQ-H | Battle start overwrites family HP via `calcEnemyMaxHp` (`WX` 11970–11974). `applyEnemyFamilyStats` (`spawnPolicy.ts` 261–272) still multiplies paper HP first. | The 30% family roll is a lie even as stat flavor. Stamp **identity** in `spawnPolicy`; do not multiply paper HP. Natural union with 021 (that PR already touches `applyEnemyFamilyStats`). | OPEN — **couple with 021** |
...
PREREQ-G (dual frontend / Motoko spell catalogs) stays a hygiene note, not a ship-blocker for 001/014/006/018/019/021/023. Align ids when a spell PR actually touches `defaultSpells()`.

---

## Ranked opportunities

| Rank | EXPANSION_ID | Title | Category | SCORE | Priority | vs 09-22 |
| ---: | :--- | :--- | :--- | ---: | :--- | :--- |
...
| 8 | EXP-2026-09-21-019 | Relative kit-band adapter (unlock authored piece kits) | ENEMIES | 25 | P0 | adopted; **must ship with F** |
| 9 | EXP-2026-09-22-021 | Family-preferred chassis overlay | ENEMIES | 25 | P0 | adopted; **ship with PREREQ-H** |
| 10 | EXP-2026-09-23-023 | One summoner slot per pack | ENEMIES / AI | 25 | P1 | **new** — first ship slice of 004 |
| 11 | EXP-2026-09-02-018 | Wire push / pull on existing ids | COMBAT | 24 | P1 | same |
| 12 | EXP-2026-08-31-010 | Optional tactical objectives | COMBAT | 24 | P1 | same |
| 13 | EXP-2026-08-31-008 | Uncapped achievement / mastery ladder | PROGRESSION | 23 | P2 | same |
| 14 | EXP-2026-08-31-013 | Explicit spell-interaction layer | COMBAT | 23 | P2 | 018 first |
| 15 | EXP-2026-09-01-016 | Wire `worldFeatures` overlay (no mapGen rewrite) | WORLD | 23 | P2 | same; freeze new `WF-*` |
| 16 | EXP-2026-09-23-024 | Wire Gravity Well via existing attract | WORLD | 22 | P2 | **new** — first unused-modifier slice of 009 |
| 17 | EXP-2026-08-31-009 | Finish unused modifiers + combo-only world rules | WORLD | 21 | P2 | same; 024 can land first |
| 18 | EXP-2026-08-31-005 | AI sophistication ladder (unused gates) | AI | 21 | P2 | same |
| 19 | EXP-2026-08-31-007 | Dungeon room types without rewriting mapGen | DUNGEONS | 21 | P2 | wait for #331 |
| 20 | EXP-2026-09-02-017 | Honor Boss Rush `combinedMechanic` | BOSSES | 20 | P2 | same |
| 21 | EXP-2026-08-31-011 | Boss mechanic-pool scaling (not more HP) | BOSSES | 17 | P3 | same |
| 22 | EXP-2026-09-22-022 | Convert Blood Moon off ×1.25 damage | WORLD | 16 | P3 | adopted |
| 23 | EXP-2026-09-01-015 | Convert Titan's Vigor off +1000 HP | WORLD | 15 | P3 | same |

**Ship-next (not the same as SCORE):** **021 + PREREQ-H** → **014** → **PREREQ-A + 019 + PREREQ-F (one PR)** → **001** → **023** (after #327) → **020** (after #327) → **018** → **024** (after walk freeze / 018) → **003** (PREREQ-J) → 002/004 remainder.
...
021 before 019 because band-0 kits already differ by piece type: coupling family → preferred chassis works **today**, lives in `spawnPolicy.ts`, and does not wait on #327. Bundle PREREQ-H in that same PR — `applyEnemyFamilyStats` is the paper-HP liar. 019 before full 001 because the piece-kit table already exists and currently cannot fire — but 019 **without F** turns late queens into healers, so A+F+019 is one change. 014 still creates family identity independent of kits. 023 is the cheapest composition decision (one summoner, not a mid-40s coin-flip swarm) but its WX call site waits on #327.
...
**IMPLEMENTATION_APPROACH:** Copy the hook-union pattern from `engine/mapModifiers.ts` (32–40). Do not apply tokens by multiplying `level * 8 + 20` again. Leader crown stays a separate identity; do not conflate `isLeader` with the first elite token until 004 recipes exist.  
...
**WHY_IT_IMPROVES_STRALT:** Band-0 kits already differ by chassis (Strike vs Frost). Family identity is currently a sticker on a random piece, so even 014 hooks land on unreadable bodies. This is the cheapest first-ship of 001’s readability axis. Lives entirely in `spawnPolicy.ts`. Does **not** wait on PREREQ-A, #327, or Motoko. Adopted from #397; this run unions PREREQ-H into the same change because that helper is the paper-HP liar.  
...
**IMPLEMENTATION_APPROACH:** Pure helper first; tests can land without WX. Do not grow WX while #327 is open. Do not also rewrite wolf/archer 50/50 in this PR.  
...
**SYSTEMS_AFFECTED:** `spellEngine.ts` / enemy-cast dispatch; occupancy (already); Swap still separate (MIMA-001 — do not fix Swap in this PR). **No damage-formula rewrite.** Open combat PRs (#379 / #417 / #432 / #441) currently race walk occupancy — wait or union landing, do not open a fifth walk path.  
...
**BALANCE_CONSIDERATIONS:** If converting to extra elite roll, wait until 002 exists or no-op the elite and use enrage instead. Do not stack with 015 on band 0. Fury potion 1.25 stays independent.  
...
- Wave 2 / 3 / 4 / 5 / 6 families, spell ids, encounter rooms, or `WF-*` rows **before** 021, 014, 019+F, 018, and 003. Open PRs #342 / #344 / #347 / #348 / #349 / #351 / #367 / #371 / #396 / #399 / #401 / #405 / #406 / #411 / #416 are **Hold**.
...
- 021 without PREREQ-H (family chassis overlay that still lies about paper HP).
- Rewriting Enemy Register from lore into a live bestiary.
- Fighting #366 on `EXPANSION_PROPOSALS_2026-09-02.md`, #397 on the 09-22 catalog, or rewriting README while #333 / #346 / #420 own it.
- Reminting 019–022 under new dates.

---

## Recommended implementation order

1. **021 Family-preferred chassis + PREREQ-H** — `spawnPolicy.ts` only; readable identity this week; stop the paper-HP lie; no #327 race.
...
5. **023 One summoner slot** — after #327 releases the battle-start loop. First composition decision.
6. **020 `kill_leader_last`** — after #327 releases `challengeCompletion.ts`.
7. **018 Push/pull on existing ids** — occupancy already tested; creates positioning combos without Motoko.
8. **024 Gravity Well** — after walk-occupancy freeze / 018, so attract is shared.
9. **003 Observed-spell discovery** — after PREREQ-J (later EOP file + deploy confirmation). Needs 001 so there is something worth observing.
10. **002 Elite tokens** + **004 Pack composition remainder** — once kits and the summoner slot exist, elites and roles multiply them.
11. **008** as the scoreboard for 001/003. **016** next for world variety (one live `WF-*`, freeze the rest). **009** fog + slime≠ice. **017** then **011**. **022 / 015 / 005 / 007** last.

Combinatorial target once 021+014+019+001+023+002+003+004+009/016+018+024 are live:

```
family × preferred chassis × relative band × piece variant × aiTier × kit band
  × elite token × pack role (incl. one summoner slot) × map archetype
  × map modifier (incl. gravity attract) × world feature × displacement verb
```
