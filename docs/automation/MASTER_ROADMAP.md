...
**Run:** 2026-09-24 00:03 UTC (daily cron)  
**This agent:** `bc-2c6667d4-fa6d-4333-85bd-54bed9eb2bca`  
**HEAD inspected:** `0f5363f` — `Merge pull request #332` (accepted-challenge HUD)  
**Prior director:** 2026-09-23 00:01 (`bc-03381915-c2b7-4ca7-88d6-0e7b125cdec9`, unmerged [#448](https://github.com/Mr-Melic/stralt/pull/448)). On `main` this file is still the 2026-09-02 text. Unmerged [#338](https://github.com/Mr-Melic/stralt/pull/338) is the 09-21 snapshot; [#402](https://github.com/Mr-Melic/stralt/pull/402) is the 09-22 snapshot.  
**Gameplay / production code:** not modified.

This file is the living prioritized roadmap. ACTION_ID records for this run live in [`ACTION_IDS_2026-09-24.md`](./ACTION_IDS_2026-09-24.md). Do **not** append to `ACTION_IDS_2026-08-31.md`, `ACTION_IDS_2026-09-01.md`, `ACTION_IDS_2026-09-02.md`, `ACTION_IDS_2026-09-21.md`, `ACTION_IDS_2026-09-22.md`, or `ACTION_IDS_2026-09-23.md`. Process audit: [`QUALITY_AUDIT_2026-08-30.md`](./QUALITY_AUDIT_2026-08-30.md). Close **#338**, **#402**, and **#448** when this PR lands (MTD-2026-09-24-002).
...
| Prior director (2026-09-23) | Memories + #448 body. P0 leftovers **not** landed. Halt-as-config **failed**; halt-as-merge-stop **held**. Validation “≤3 new gameplay PRs from the 09-23 wave” **failed**. |
| Specialist reports on `main` | Still dated 2026-09-02 (plus orchestrator [`ACTION_IDS_2026-09-03-0000.md`](./ACTION_IDS_2026-09-03-0000.md)). 09-21/09-22/09-23 reports exist only on unmerged drafts. |
| Open ACTION_IDs | Hundreds still `NEW` across dated producer files. Reuse; do not mint twins. |
| Recent commits | `main` last moved 2026-09-03 00:28 UTC. **Zero** commits for **21 days**. HEAD still `0f5363f`. |
| Open drafts | **171**, all draft: leftover **#327** (Striker) + **#331** (mapGen HOLD) + **#333–#446** (09-21/09-22 flocks) + **#447–#501** (09-23 flock, which became gameplay) + this run. |
...
| Same-hour flock (this minute) | **18** RUNNING at 00:03 UTC 2026-09-24, including Approved Game Design Implementer `fe5b679a` (**enabled and visible this run**), combat parity `f37b7505` (**enabled**), persist/data-evolution `469b7020`, economy `1e548d83`, admin safety `7e907066`, map guardian `9dcfd122` (**enabled**), expansion `3f31b18f` (**enabled**), AI `67b03c2f` (**enabled**), defect recurrence, perf `4191af8a` (**enabled**), TBC (correctly WAITING), telemetry dashboard, world mechanics, enemy/boss admin, game balance, maintainability. `996df6df` still not GetAutomation-visible. |
...
| ENGINEERING EVIDENCE | Code on `0f5363f`, tests, **171**-draft queue, Caffeine `.old` still the 2026-08-31 no-GameKey signature |

Telemetry is not allowed to set priority. Correlation is not causation. No CLEAR_POSITIVE_SIGNAL is claimed.

---

## What changed since the 09-23 director run (24 hours)

The 09-23 run asked: halt the flock; do not merge-burst ~116 leftover drafts; confirm Caffeine deploy; write the ADR; restack #327; close #338 and #402.

**What actually happened**

| Ask | Outcome |
| :--- | :--- |
| Halt 09-23 implementers | **Config failed.** Wave opened **#447–#501** (**55** new drafts) across 00:00 plus 06/08/12/15/16/18/21 crons. |
| ≤3 new gameplay PRs from 09-23 | **Failed.** Combat-parity, persist, mapGen, admin, economy, UX, RAF, extracts, tests. |
| Humans merge the flock | **Did not.** `main` still `0f5363f`. Merge-stop held a **third** full day (**21 days** total). |
| Merge director #338 / #402 / #448 | **Did not.** `main` still serves the 09-02 roadmap. Four living director files now exist. |
...
| Restack #327 | **Still open**, now **22 days** stale. Twin **#370** still open. |
| Hold eight mapGen punches | **Held on `main`**, but 09-23 cloned **#484 / #486 / #494 / #500**. **Twelve** open mapGen punches. |
| `fe5b679a` stay invisible / idle | **Failed.** Approved Game Design Implementer is **RUNNING this hour**. |
...
**09-23 leftovers that are NOT done:** flock halt, deploy confirmation, ADR, #327, landing helper, kit-zone number, ownership persist, occupants on `findPath`, GameKey × unpaid death **wiring**, mapGen freeze, director-index merge.
...
| **#385** | Unpaid death-pending scoped to II principal. | After halt. Isolated persist honesty. Do not sequential-merge with #490/#497. |
| **#333** | TBC WAITING_FOR_TELEMETRY docs. | OK after P0 docs/index. Later TBC drafts (#395/#462) are dated twins — keep one. |
| **#354** | Feats vs Achievements recap copy. | P3 display-only when WX is quiet. |
| **#338 / #402 / #448** | Prior director roadmaps. | **Close** — this file subsumes all three. |

**Overlap / HOLD (09-21 leftovers plus 09-22/09-23 clones):**

- mapGen: **#331 #373 #378 #383 #428 #430 #436 #444 #484 #486 #494 #500** (twelve)
- persist cluster: **#356 #375 #377 #387 #388 #408 #426 #431 #435 #439 #445 #482 #488 #490 #493 #497 #499**
- combat-parity WX: **#340 #379 #389 #417 #432 #440 #441 #443 #446 #467 #483 #487 #489 #495 #496 #498**
- RAF / walk stepper: **#501** — `AGENTS.md` forbids RAF edits. **Hold.**
- AdminDashboard: **#334 #341 #413 #415 #437 #457 #460 #470**
- feel/UX/a11y/perf/extract: **#335 #350 #363 #364 #368 #369 #372 #376 #412 #421 #423 #425 #427 #429 #438 #464 #468 #485 #492**
- catalog docs: keep one discovery persist shape (SDA-002/004); do not author a fifth schema. 09-23 added another overlapping SDA/SDE/EBA/AI/formations/world/boss/visual/telemetry wave.
...
ENGINEERING: Death replay, live Doka refs, ignore-client level, Frozen MP, barrier A*, GameKey replacing 60s auto-complete, later-file EOP. Do not open a seventh persist rewrite.
...
Recurring defect class: **kit zone NaN.** `buildEnemyKit` takes a number (`enemyAI.ts` 194–199). Battle start still passes `currentMap.levelZone` (`WX` 11920). `currentZoneTier` is already a number (`WX` 1136 / 4680). **Sixth** director cycle.

Recurring defect class: **mapGen portal punch vs battle graph.** #110 → leftover islands → destack → relocate hostiles → punch adjacent floor → **twelve** open drafts. Controlled intervention = one battle-graph policy helper + fixtures. Do **not** auto-refactor. Hold all twelve punches.
...
Recurring defect class: **unseeded wallet HUD.** 09-22 persist hunters opened one-shot / victory / GameKey hydrate twins. 09-23 cloned **#482 / #488 / #493 / #499** (skip-wipe / refuse-stale-seed). That is “repeated patches on one subsystem.” Hold the cluster; do not sequential-merge.

Recurring defect class: **preview vs execute / live-store HP.** 09-23 combat-parity and critical-defect hunters opened Timestep/Mirror self-tile (#496), betrayal death pipeline (#487), Shell Armor leftovers, Life Drain vs live HP (#440). Some may be unique. None should land during a 171-draft freeze. Extract helpers after halt; do not grow WX.
...
### 3. Technical health — hotspot + 171-draft queue + unconfirmed deploy

| Surface | Lines now | 09-23 director | Verdict |
| :--- | ---: | ---: | :--- |
...
| `mapGen.ts` | 1,937 | 1,937 | Twelve open punches; freeze badly broken |
...
Four unmerged director PRs on the same living files (#338/#402/#448/this) is itself a stack-compat defect. Close the three older snapshots. Do not merge all four.

### 4. Content depth — over-specified, under-wired, catalog mill on a fourth consecutive midnight
...
09-21 through 09-23 specialists produced overlapping catalog waves (SDA, SDE, EBA, AI, formations, elite, world, encounter, visual, boss, expansion, telemetry). That is **expansion overlap**. Default **hold** implementation. 09-24 designers/implementers already RUNNING (Approved Game Design `fe5b679a`, expansion, AI, world, enemy/boss admin).
...
Expansion that adds spells, AI behaviors, or admin chrome **before** Caffeine deploy confirmation, landing-authority extraction, and a reward-trust ADR will not scale. `fe5b679a` running tonight is the opposite of that gate.
...
09-23 persist hunters also opened principal-scoped BuffShop/feat counters (#490) and unpaid-death Doka on every character slot (#497). Those overlap #385. One principal-keying helper later; not three PRs tonight.

### 7. Automation coherence — P0; merge-stop held 21 days, config failed a seventh midnight
...
09-21 cron opened **59** PRs. 09-22 cron opened **~55 more**. 09-23 cron opened **55 more**. Humans did **not** merge them. That is a **partial** win: the queue is now the risk. 09-02 showed what happens when that queue is merged in 30 hours.

09-24 00:00 relaunched Approved Game Design Implementer, combat parity, persist, economy, admin safety, expansion, AI, and the map guardian against a **171-draft** queue. Cursor Cloud has **no write API** for dashboard prompts. Halt is a human config action. In-repo gates are the enforceable half.

`fe5b679a` was not GetAutomation-visible on 09-21/09-22/09-23 director runs. It is **visible and RUNNING** this hour. That is a config regression, not a rediscovery.

| AQA / MTD ID | Director status 2026-09-24 |
| :--- | :--- |
| AQA-001 hunter throttle | **OPEN** — `996df6df` still not GetAutomation-visible. |
| AQA-002 one critical hunter | **OPEN** — volume problem remains combat/persist/admin/economy/map/Approved-Design implementers. |
| AQA-003 in-repo ACTION_ID ledger | **PARTIAL** — 09-02 file clean; 09-21/09-22/09-23 ledgers never reached `main`. This run writes 09-24 only and unions the prior files. |
| AQA-004 don’t merge the 08-30 stack | **SUPERSEDED** — accept `main`. |
| AQA-005 test clone mill | **PARTIAL** — mill still firing. |
| AQA-006 no mapGen implementation | **BROKEN** — **twelve** open punches. Guardian `9dcfd122` enabled and RUNNING. |
| AQA-007 freeze drive-by WX | **BROKEN** — combat parity RUNNING again; leftover WX drafts plus 09-23 mill. |
| AQA-008 security → ADR | **PARTIAL** — clamps on `main`; no ADR. |
| AQA-009 orchestrator must not implement gameplay | **PARTIAL** — leftover isolated helpers. Acceptable if they stay helper-shaped. **#501 RAF** is not helper-shaped — hold. |
| AQA-010 persist/economy dedup | **PARTIAL** — cluster landed on `main`; 09-21/09-22/09-23 opened another persist pile. Economy RUNNING tonight. |
| AQA-011 prompts vs live architecture | **OPEN** |
| AQA-012 outcome telemetry | **OPEN** — dashboard/architecture drafts with nothing to display. TBC correctly WAITING this hour. |
| MTD-001 flock halt | **OPEN** — merge-stop held **21 days**; config failed 08-31, 09-01, 09-02, 09-21, 09-22, 09-23, **09-24**. |
| MTD-2026-09-21-002 | **OPEN** — confirm Caffeine deploy + refresh `.old`. |
| MTD-2026-09-23-001 | **SUPERSEDED** — 09-23 wave already happened; validation failed. |
| MTD-2026-09-23-002 | **OPEN** — close #338 and #402; this PR also closes #448. |
| MTD-2026-09-23-003 | **OPEN** — leftover queue grew 116 → **171**. |
| MTD-2026-09-23-004 | **OPEN** — 09-22 clone mill held on `main`; 09-23 cloned it again. |
| MTD-2026-09-24-001 | **NEW** — hold the 09-24 00:00 wave. |
| MTD-2026-09-24-002 | **NEW** — close #338, #402, and #448; this file is the index. |
| MTD-2026-09-24-003 | **NEW** — do not merge-burst 171 drafts. |
| MTD-2026-09-24-004 | **NEW** — hold the 09-23 mapGen/persist/combat/RAF clone mill. |
...
4. **mapGen portal-punch vs battle graph** — nine punches on `main` plus **twelve** open drafts. One policy helper + seed fixtures. Hold further punches.
...
6. **Unseeded / in-flight wallet HUD** — #330 closed the keep; 09-22 and 09-23 opened twins. Stop patching `progressPersist` callers in parallel.
7. **Canister trust** — write the ADR (AQA-008). Until it exists, no new credit APIs and no discovery grant writer.
8. **Automation flock + leftover queue** — one critical hunter; report-only on cron restart; **do not merge 100+ leftover gameplay drafts to clear the button.** Disable `fe5b679a` until P0/P1 close. This is still the binding constraint.
9. **RAF / walk-stepper races** — #501. `AGENTS.md` forbids RAF edits. Local patches here are the wrong tool; hold.
...
| Order | PR | Action |
| :--- | :--- | :--- |
| 1 | **This docs PR** | Living roadmap + `ACTION_IDS_2026-09-24.md`. Close **#338**, **#402**, and **#448** (same living files, stale snapshots). |
...
| — | **#385** | After halt. Do not sequential-merge with #490/#497. |
| — | **#331 #373 #378 #383 #428 #430 #436 #444 #484 #486 #494 #500** | **Hold.** mapGen portal-graph. AQA-006 / MTD-2026-09-24-004. |
| — | Persist / combat-parity / AdminDashboard / feel / UX / a11y / perf / extract / **#501 RAF** | Default **hold** this cycle. |
| — | Docs catalogs from 09-21/09-22/09-23 | OK **after** P0/P1 if they do not rewrite SDA/SDE/EBA schemas or retune BAL-*. |
| — | Any later PR from the 09-24 00:00 wave | Default **hold** if gameplay. Especially mapGen, targeting, persist, `enemyAI`, AdminDashboard, `main.mo` stables, telemetry UI, WX, RAF. |
...
1. Halt the 09-24 same-hour implementer flock (MTD-2026-08-31-001, MTD-2026-09-24-001). Disable or pause `fe5b679a`, `f37b7505`, `9dcfd122`, `3f31b18f`, and `67b03c2f`.
2. Triage the 171-draft leftover queue — do not merge-burst (MTD-2026-09-24-003 / 004). Close #338, #402, and #448 (MTD-2026-09-24-002).
...
6. Re-freeze `mapGen.ts`, `targeting.ts`, `enemyAI.ts`, and WX drive-bys (AQA-006, AQA-007). Hold all twelve mapGen punches.
...
18. BuffShop `buffInventories` vs `${principal}_inventory` (SDEG-005) — after persist quiet. Fold #385/#490 principal-keying here, not as parallel PRs.
...
| Solvability vs `AGENTS.md` mapGen | #110 plus later punches already merged; **freeze**; hold all twelve open punches. |
...
| Expansion specialists vs “P0/P1 first” | Leftover catalogs + 09-24 `fe5b679a` are the violation. Hold implementation. |
...
| 21-day freeze vs “halt failed” | Halt failed as **config**. It succeeded as **human merge stop**. Cron restart without dashboard change undoes the config half; merging the leftover queue undoes the merge-stop half. |
| #338 / #402 / #448 vs this PR | This file subsumes all three. Close them without merge. |
| 09-22/09-23 persist HUD twins vs #330 keep | #330 is on `main`. Hold the twins; do not open a fifth keep path. |
...
1. **Halt the 09-24 00:00 implementer flock** (especially `fe5b679a`) and **do not merge-burst the 171 leftover drafts**. First-run and expansion specialists: ACTION_IDs only. Especially hold mapGen, persist, targeting, `enemyAI`, AdminDashboard, `main.mo` stables, telemetry UI, WX, RAF.
...
5. **Close #338, #402, and #448** when this living roadmap lands, so the next wave plans against 09-24 facts instead of the 09-02 index still on `main`.
...
- Enemy AI capability expansion — `enemyAI.ts` already 2,580 lines; kits never leave zone 0; HP/death still dual-written. `fe5b679a` / `67b03c2f` must not implement tonight.
...
- Further `mapGen.ts` punches (twelve open drafts and tonight’s Guardian) without an explicit human playtest of the #321→#329 sequence.
...
- Sequential merge of the 100+ leftover gameplay drafts “to clear the queue.”
- RAF / walk-stepper edits (#501).

## SAFE EXPANSION WORK

- Land this docs PR; close #338, #402, and #448.
...
- `src/frontend/src/engine/mapGen.ts` (including all twelve open punches)
...
- `docs/automation/ACTION_IDS_2026-08-31.md`, `ACTION_IDS_2026-09-01.md`, `ACTION_IDS_2026-09-02.md`, `ACTION_IDS_2026-09-21.md`, `ACTION_IDS_2026-09-22.md`, `ACTION_IDS_2026-09-23.md` (do not append)
...
5. Automation pile-on (**171** leftover drafts + 09-24 restart, including `fe5b679a`) — merge-stop held 21 days, config failed a seventh midnight
6. mapGen portal-punch / battle-graph (nine punches on `main`; **twelve** open drafts)
...
10. Unseeded-wallet HUD twins stacked on the #330 keep
11. Four unmerged director snapshots on the same living files
...
9. unseeded-lock HUD vs committed Doka after one-shot / GameKey / feat (09-22/09-23 persist twins — if wallet “resets,” ENGINEERING is hydrate, not player spend)
