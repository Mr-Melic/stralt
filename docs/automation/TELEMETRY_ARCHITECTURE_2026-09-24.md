# Gameplay telemetry architecture — 2026-09-24
...
**Prior designs (unmerged, same SHA):** PRs **#352** (09-21), **#422** (09-22), **#450** (09-23). On `main` the last merged design is [`TELEMETRY_ARCHITECTURE_2026-09-02.md`](./TELEMETRY_ARCHITECTURE_2026-09-02.md). Ledger: [`ACTION_IDS_GTAD_2026-09-24.md`](./ACTION_IDS_GTAD_2026-09-24.md).  
...
The 2026-08-31 through 09-23 **fail-open increment sidecar** is **reaffirmed**. This run does **not** invent a second architecture. `main` has **not moved** since the 09-21 cron (`0f5363f`). EVENT_SOURCE line numbers below were **re-read** on this SHA (battle start **12097–12099**, recap **12517**, dual death **13261** vs **13316**, flee **18935**, GameKey helper **275–279**, recap dismiss five `onClose` sites). They match 09-23.

This file patches three implementer hazards that 09-23 left stale:

1. **Open-PR queue grew again.** Oldest-first merge order is still **#327** then **#331**, then **#333–#520** — **190** still-open PRs targeting `main` (createdAt ascending, GitHub list 2026-09-24 ~00:16 UTC via `open-pr-stack-compat.sh`). Unmerged GTAD designs are **#352** (09-21), **#422** (09-22), and **#450** (09-23). Do not hitchhike telemetry maps, bindgen, or sidecar call sites onto any of them. Union README index rows; unique 09-24 files must not overwrite #352/#422/#450 unique files. Pre-existing queue breaks (#389 WX, #392 ChatPanel, later combat/map/persist PRs) are not this PR’s unique delta.
2. **Queued persist PRs still are not EVENT_SOURCE.** 09-23 deferred Q-018 against **#375 / #377 / #387 / #391 / #426 / #431 / #435 / #439 / #445**. Those remain open. Additional persist PRs opened after the 09-23 cron: **#482** (refuse stale unseeded wallet seed after GameKey/feat credit), **#488** (skip `saveBattleStats` wipe after unseeded small feat grant), **#490** (key BuffShop and feat counters by II principal), **#493** (skip wipe after unseeded one-shot keep), **#497** (honour unpaid death Doka on every character slot), **#499** (skip wipe after unseeded victory keep), **#508** (keep unpaid death keys across version wipe). On **main**, `noteUnconfirmedCredit` is still only the one-shot settle path (`dokaPersist.ts` **217–239**). No `unseededKeepWriteSkip` / `unseededVictoryKeepWriteSkip` helpers exist on `main`. Do not invent spend-note writers. Do not treat unmerged branch helpers as live increment sites.
3. **Recap dismiss five-path list is still correct** (re-read `PostBattleRecap.tsx` 2026-09-24): Escape **67–68**, backdrop **93–96**, overlay Enter/Space **98–111**, close **208**, Continue **609**. Increment **once**. Sibling TADD **#504** skipped a fourth Health matrix because these APIs are still absent. Sibling TBC **#502** remains `WAITING_FOR_TELEMETRY`. World-dynamics **#503** is still catalog-only (N-007).
...
| Topic | 2026-09-23 (PR #450, SHA `0f5363f`) | 2026-09-24 (this cron, same SHA) |
| :--- | :--- | :--- |
...
| Open sibling PRs | **116** open through **#446** | **190** open through **#520**. Oldest still **#327** then **#331**. GTAD siblings **#352** + **#422** + **#450**. TBC WAITING **#333/#395/#462/#502**. Dashboard **#345/#424/#455/#504** (09-24 TADD **skipped** a fourth Health matrix). |
| Persist PRs (not EVENT_SOURCE) | #356/#375/#377/#385/#387/#388/#391 + #426/#431/#435/#439/#445 | Those still open, **plus** #482/#488/#490/#493/#497/#499/#508. Q-018 still deferred. No `unseeded*KeepWriteSkip` on `main`. |
...
| World features | Catalog only; WX does not import | Unchanged on `main`. Open **#503** adds a wave-7 catalog + tests; still **no** `WorldExploration.tsx` importer. N-007 stays dormant. |
...
10. Hitchhike onto still-open **#327** / **#331** or any later still-open persist/combat PR (**#340**, **#356**, **#375**, **#377**, **#379**, **#387**, **#389**, **#391**, **#426**, **#431**, **#435**, **#439**, **#445**, **#482**, **#488**, **#490**, **#493**, **#497**, **#499**, **#501**, **#508**, …). Dedicated human-approved PR after those land, or a human-unioned restack. Unique 09-24 files must not overwrite unmerged **#352** / **#422** / **#450**.
...
| Editing frozen `NewActor`s or hitchhiking telemetry onto #327 / #331 / later persist-combat PRs (now through **#520**) | EOP + stack-compat. Overwriting #352/#422/#450 unique files is also forbidden. |
...
| Implementing Q-018 against unmerged #375/#377/#387/#391/#426/#431/#435/#439/#445/#482/#488/#490/#493/#497/#499/#508 | EVENT_SOURCE must be on `main`. |
...
12. After older queue items merge, **re-read EVENT_SOURCE line numbers** before implementing. This catalog is valid at `0f5363f` only. The 190-PR queue will move WX/persist lines the moment **#327** / **#331** land.
...
| Balance / Content Analyst (`2786666f`) | Stay `WAITING_FOR_TELEMETRY` (open **#502** already says so). | Use Phase 2 dimensions; never invent OVERPERFORMING from source. Enemy Register is lore (N-008). |
| Dashboard Designer (`4b026695`) | Snapshot panels + honest “not measured.” Shop series = GameKey. H14 audit log is ops, not battles. Open **#504** correctly skipped a fourth Health matrix. | Bind to `adminGetTelemetrySnapshot` / progression snapshot only. |
...
Related: `AQA-2026-08-30-012` (still NEW; shop site patched in 09-21). `GTAD-2026-09-01-*` remain the implementation tickets; **read this file for line numbers, GameKey helper, one-shot, recap-dismiss, EOP, and the 190-PR stack fence.** `GTAD-2026-09-02-*`, `GTAD-2026-09-21-*` (PR #352), `GTAD-2026-09-22-*` (PR #422), and `GTAD-2026-09-23-*` (PR #450) are still NEW additive deltas. `GTAD-2026-09-24-*` are this run’s deltas only.
