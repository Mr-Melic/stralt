# ACTION_IDs — Gameplay Telemetry Architecture Director 2026-09-22

Durable ledger for implementers and the Report Action Orchestrator.  
Source of every record: Gameplay Telemetry Architecture Director  
(`047ac8a1-a4a0-11f1-a7d1-d6b4613131ce`).  
Design contract: [`TELEMETRY_ARCHITECTURE_2026-09-22.md`](./TELEMETRY_ARCHITECTURE_2026-09-22.md).  
...
are still NEW. 09-21 deltas live on unmerged PR **#352**  
(`ACTION_IDS_GTAD_2026-09-21.md`). This run adds **deltas only** (expanded  
stack fence, recap-dismiss five-path correction, deferred Q-018).
...
HEAD inspected: `0f5363f` (unchanged since 09-21). Oldest still-open PRs at this cron: **#327** then **#331**, then #333–#409 (79 open).

---

ACTION_ID: GTAD-2026-09-22-001  
...
DEPENDENCIES: GTAD-2026-09-01-001; GTAD-2026-09-02-001; GTAD-2026-09-21-001 (still NEW; this ID refreshes the citation path)  
...
ACTION_ID: GTAD-2026-09-22-003  
SOURCE_AUTOMATION: Gameplay Telemetry Architecture Director  
TITLE: Recap dismiss is five discrete onClose sites — increment once; 09-21 mislabeled line 111 as backdrop  
CATEGORY: telemetry  
PRIORITY: P2  
CONFIDENCE: HIGH  
EVIDENCE: `PostBattleRecap.tsx` Escape 67–68, backdrop click 93–96, overlay Enter/Space 98–111, close button 208, Continue 609. All call `onClose`. 09-21 listed four sites and called 111 backdrop. Recap open sites unchanged: victory 12517, Boss Rush 12925, HP-watch defeat 13355.  
SYSTEMS_AFFECTED: `PostBattleRecap` wrapper or `onClose` once; Q-004 / Q-005  
RECOMMENDED_ACTION: Dedup to one `quality.recap.dismissed` per recap instance. Do not scrape canvas. Do not store enemy-name breakdowns. Prefer wrapping the `onClose` prop over instrumenting each UI path.  
AUTONOMY: IMPLEMENT_AFTER_HUMAN  
DEPENDENCIES: GTAD-2026-09-01-004; GTAD-2026-09-21-009 (prefer this ID for site list)  
REGRESSION_RISK: LOW.  
VALIDATION_REQUIRED: Escape + Continue in one recap = one increment. Overlay Enter + backdrop click also = one.  
STATUS: NEW  

---

ACTION_ID: GTAD-2026-09-22-004  
SOURCE_AUTOMATION: Gameplay Telemetry Architecture Director  
TITLE: Do not hitchhike telemetry onto the 79-PR oldest-first queue; union README; #352 is the 09-21 sibling  
CATEGORY: process  
PRIORITY: P1  
CONFIDENCE: HIGH  
EVIDENCE: Oldest still-open PRs targeting main (createdAt ascending): #327 Striker AoE (WX, challenge, targeting, dokaPersist), #331 portal destack (WX, mapGen, persist), then #333–#409 (79 open). Unmerged 09-21 GTAD design is #352 (`TELEMETRY_ARCHITECTURE_2026-09-21.md`). Telemetry stables need bindgen/mocks — do not land them on #327/#331/#340/#356/#375/#377/#379/#387/#389/#391. This docs PR adds unique 09-22 files and README index rows that must **union** with older docs PRs, not overwrite. Pre-existing queue breaks (#389 WX, #392 ChatPanel) are not this unique delta.  
SYSTEMS_AFFECTED: future Motoko/sidecar PR; stack-compat CI; README.md index  
RECOMMENDED_ACTION: Keep this architecture PR docs-only. Land Phase 0/1 in a dedicated PR after #327/#331 (or a human-unioned restack). After older queue items merge, re-read EVENT_SOURCE line numbers. Run `bash scripts/open-pr-stack-compat.sh --self`.  
AUTONOMY: IMPLEMENT_AFTER_HUMAN  
DEPENDENCIES: GTAD-2026-09-21-005; GTAD-2026-09-21-008  
...
ACTION_ID: GTAD-2026-09-22-005  
SOURCE_AUTOMATION: Gameplay Telemetry Architecture Director  
TITLE: Q-018 throw-after-mutation notes stay deferred until persist PRs merge — do not invent spend-note helpers  
CATEGORY: telemetry  
PRIORITY: P2  
CONFIDENCE: HIGH  
EVIDENCE: On main, `noteUnconfirmedCredit` is already called from one-shot settle (`dokaPersist.ts` 217–239); that path is Q-015 keep + Q-016 `shouldSkipAbsoluteDokaWrite` (progressPersist.ts 202–212). Open PRs #375 / #377 / #387 / #391 propose additional throw-after-credit/debit notes. Those helpers are **not** on `0f5363f`.  
SYSTEMS_AFFECTED: future sidecar flush after persist-note helpers; Q-015 / Q-016 / Q-018  
RECOMMENDED_ACTION: Do not implement Q-018 against unmerged branches. After those PRs merge, increment `quality.persist.throw_after.{credit|spend}` **after** the note helper returns, off the lock. Never double-count the live one-shot keep as Q-018. Never release a keep because the sidecar threw.  
AUTONOMY: IMPLEMENT_AFTER_HUMAN  
DEPENDENCIES: GTAD-2026-09-21-004; merge of persist PRs #375/#377/#387/#391 (or equivalent on main)  
...
Implementers should execute these 09-01 IDs against **09-22 line numbers**:

| ID | Title (short) | 09-22 note |
| :--- | :--- | :--- |
| GTAD-2026-09-01-001 | Aggregates only; no principals | Extended by 09-02-001, 09-21-001, 09-22-001 |
| GTAD-2026-09-01-002 | Fail-open sidecar; not on persist lock | Extended by 09-21-002 / 09-22-002 (`beforeEach` + one-shot keep) |
| GTAD-2026-09-01-003 | Phase 0 snapshot buckets | `getAllCharacters` now `main.mo` 532; optional GameKey **status** histogram |
| GTAD-2026-09-01-004 | Phase 1 outcome + quality hooks | Shop hook = 09-21-003; recap dismiss = **09-22-003**; add Q-015/Q-016; Q-018 deferred |
...
| GTAD-2026-09-01-010 | Sibling prompts stay WAITING | Citation path superseded by 09-22-006 |
...
| :--- | :--- |
| GTAD-2026-09-02-001 | 09-22-001 (same fence) |
| GTAD-2026-09-02-002 | **09-21-003** (`shouldCommitGameKeyRedeem`) |
| GTAD-2026-09-02-003 | Still valid (unpaid death replay Q-014); `beforeEach` note in 09-22-002 |
...
| GTAD-2026-09-02-007 | 09-22-006 (citation path) |

09-21 IDs still NEW on unmerged PR #352 (do not re-file; prefer 09-22 where they overlap):

| ID | Prefer instead when implementing |
| :--- | :--- |
| GTAD-2026-09-21-001 | 09-22-001 |
| GTAD-2026-09-21-002 | 09-22-002 |
| GTAD-2026-09-21-003 | Still the GameKey predicate ID (`shouldCommitGameKeyRedeem`) |
| GTAD-2026-09-21-004 | Still Q-015/Q-016; Q-018 is 09-22-005 |
...
| GTAD-2026-09-21-008 | **09-22-004** (queue is now 79 PRs) |
| GTAD-2026-09-21-009 | **09-22-003** (five onClose sites) |
| GTAD-2026-09-21-010 | 09-22-006 |
