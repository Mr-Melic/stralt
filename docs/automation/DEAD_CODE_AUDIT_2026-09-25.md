# Dead-code / legacy-drift audit — 2026-09-25
...
**Prior pass:** `docs/automation/DEAD_CODE_AUDIT_2026-09-24.md` (queued on open **#516**; 2026-09-23 is **#469**; 2026-09-22 is **#423**; 2026-09-21 is **#339**)  
...
`main` has not moved since the 2026-09-21 / 09-22 / 09-23 / 09-24 audits (`0f5363f`). This run independently re-scans that baseline, unions the still-queued #339 / #423 / #469 / #516 CSS/docs hunk (so the cleanup lands even if those drafts close), and records newer sibling-PR context (**235** open PRs targeting `main` through **#565** at stack-compat time).
...
| **#516** (2026-09-24 dead-code audit) | Same CSS + check-limit row | Identical hunks. |
| **#526** | Shop/forge 44px a11y | Does **not** edit `index.css` or BoostToggle. Do not enlarge the 44px selector list here. |

No other still-open PR besides #339 / #423 / #469 / #516 edits `src/frontend/src/index.css`.
...
| `utils/longHorizonSim.ts` | CLI/dev balance tool (test-imported). Open **#475** / **#530**. |
...
- New high-confidence dead files since 2026-09-24. The only non-test, non-entry `.ts/.tsx` with zero importers remains `BoostToggle.tsx` (plus the unused shadcn kit and `summonAI.ts`).

## Re-verified / corrected from 2026-09-24
