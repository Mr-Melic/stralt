# ACTION_IDs — 2026-09-26 Master Technical Director
...
**Prior director:** unmerged [`#569`](https://github.com/Mr-Melic/stralt/pull/569) + memories (`bc-d12f7f6b-ca67-4cc8-b1b6-1f312225e612`). Unmerged [`#338`](https://github.com/Mr-Melic/stralt/pull/338) / [`#402`](https://github.com/Mr-Melic/stralt/pull/402) / [`#448`](https://github.com/Mr-Melic/stralt/pull/448) / [`#509`](https://github.com/Mr-Melic/stralt/pull/509) are earlier snapshots. On `main`, [`MASTER_ROADMAP.md`](./MASTER_ROADMAP.md) is still the 2026-09-02 text.  
**This agent:** `bc-1964182f-c9b5-49dd-bb8d-aec03d6fc82f`  
**Gameplay / production code:** not modified this run.

Specialist IDs stay in their producer files. Do not concatenate into this ledger. Do not append to `ACTION_IDS_2026-08-31.md`, `ACTION_IDS_2026-09-01.md`, `ACTION_IDS_2026-09-02.md`, or `ACTION_IDS_2026-09-21.md` through `ACTION_IDS_2026-09-25.md`.
...
| :--- | :--- | :--- |
| MTD-2026-08-31-001 / MTD-2026-09-01-001 | OPEN | Halt-as-config failed 08-31, 09-01, 09-02, 09-21, 09-22, 09-23, 09-24, 09-25, **09-26**. Halt-as-merge-stop held **23 days** (`main` still `0f5363f`). |
...
| MTD-2026-09-24-001 | SUPERSEDED | 09-24 wave already happened. |
| MTD-2026-09-25-001 | SUPERSEDED | 09-25 wave already happened. Validation “≤3 new gameplay PRs” **failed** (28 non-docs in #556–#608). See MTD-2026-09-26-001 / 003 / 004. |
...
| MTD-2026-09-02-004 / AQA-2026-08-30-003 | PARTIAL | 09-02 file stayed clean. 09-21…09-25 ledgers never landed on `main`. This run writes `ACTION_IDS_2026-09-26.md` only. |
| MTD-2026-09-21-003 | OPEN | **#327 still open** (oldest draft, **24 days** stale, `mergeable: CONFLICTING`). #370 is a later Striker **superset**. |
| MTD-2026-09-21-004 | OPEN | #331 still open. Hold all **twenty** mapGen punches (prior sixteen plus dump-alcove **#589 #600 #603 #608**). |
| MTD-2026-09-22-002 / 23-002 / 24-002 / 25-002 | OPEN | Close #338/#402/#448/#509/#569. Subsumed by MTD-2026-09-26-002. |
| MTD-2026-09-22-003 / 23-003 / 24-003 / 25-003 | OPEN | Leftover queue grew 59 → 116 → 171 → 230 → **279**. See MTD-2026-09-26-003. |
| MTD-2026-09-22-004 | OPEN | #370 still HOLD until after #327. |
| MTD-2026-09-25-004 | OPEN | Clone mill held on `main`; 09-25 cloned dump-alcove / Death Realm skip / live-gate. See MTD-2026-09-26-004. |
| MTD-2026-09-25-005 | OPEN | Oldest-first still makes the living index unreachable. #327 now 24 days CONFLICTING; queue 279. |
| AQA-2026-08-30-008 | PARTIAL | Clamps + ignore-client level + AP/MP cap; **no ADR** (`docs/**/*ADR*` = 0). |
| AQA-2026-08-30-006 | BROKEN | mapGen still **1,937**. Twenty open punch PRs. Guardian `9dcfd122` enabled. |
...
| AQA-2026-08-30-012 | OPEN | Still 0 collectors. TBC correctly WAITING (#609). Dashboard RUNNING this hour — skip UI. |
| TBC-2026-08-31-001 | OPEN | WAITING_FOR_TELEMETRY. Confirmed this run (#609). |
| MIMA-2026-08-31-001 | OPEN | Swap still teleports (`WX` 9389–9402). No `applyHazardLanding`. **#541** HOLD. |
...
| MIMA-2026-09-02-003 | OPEN (helper drafted) | `redeemGameKeyThroughPersist` still raw lock+grant. **#391** adds the helper, **does not wire** redeem. `gameKeyUnpaidDeath.ts` not on `main`. |
...
| EXPANSION-PREREQ-A | OPEN | `WX` 11920 still passes LevelZone object. Number already at 1136 / 4680. Eighth cycle. |
| MTD-2026-08-31-003 | OPEN | HP/death extraction. Not tonight. |
| MTD-2026-08-31-004 | OPEN | Expansion freeze. Expansion `3f31b18f` RUNNING this hour. AI `67b03c2f` enabled. `fe5b679a` not GetAutomation-visible. |
...
PRIORITY: P0  
CONFIDENCE: HIGH  
EVIDENCE: Failed 2026-08-31, 09-01, 09-02 (humans then merged). Halt-as-merge-stop then held **23 days** (`main` still `0f5363f`). Recurred 09-21 (59 drafts), 09-22 (55), 09-23 (55), 09-24 (54), 09-25 (53 drafts / 28 non-docs). Recurred **2026-09-26 00:03**: **14** automations already launched including expansion `3f31b18f` (enabled, RUNNING), combat parity `f37b7505` (enabled, RUNNING), telemetry dashboard `4b026695` (RUNNING), world content/mechanics, enemy formations, game feel, admin regression, mechanic matrix, defect recurrence. Map guardian `9dcfd122`, economy `1e548d83`, AI `67b03c2f`, and security `c97e5c0c` remain **enabled**. `fe5b679a` and `996df6df` still not GetAutomation-visible. `1aa41c6c` remains enabled. Cursor has no dashboard write API. Queue now **279** drafts.  
SYSTEMS_AFFECTED: all implementer automations; 279-draft merge queue; live Caffeine upgrade  
...
REGRESSION_RISK: LOW  
VALIDATION_REQUIRED: Next director run sees ≤3 **new** gameplay PRs from the 09-26 wave, and those PRs do not retouch persist / targeting / mapGen / WX / RAF / `main.mo` stables. The leftover queue is not merge-bursted. Expansion/AI do not open a gameplay PR.  
STATUS: OPEN  

---

ACTION_ID: MTD-2026-09-26-001  
SOURCE_AUTOMATION: Stralt Master Technical Director  
TITLE: Hold the 2026-09-26 00:00 specialist wave  
CATEGORY: automation-coherence  
PRIORITY: P0  
CONFIDENCE: HIGH  
EVIDENCE: Same HEAD as 09-21…09-25. P0 leftovers (Caffeine deploy, ADR, #327 restack, director-index merge) still open. **279** drafts already in the queue. This hour already launched expansion, combat parity, telemetry dashboard, world/formations/feel/admin. 09-25’s first-hour docs-only PRs did **not** stay docs-only by end of day (28 non-docs). TBC #609 WAITING is acceptable.  
SYSTEMS_AFFECTED: merge queue; `WorldExploration.tsx`; `mapGen.ts`; `main.mo`; AdminDashboard; migrations; RAF  
RECOMMENDED_ACTION: Default HOLD any gameplay PR from this wave. Designers update their own dated files; do not rewrite SDA/SDE/EBA schemas; do not restack GameKey, Frozen MP, spawnPolicy, death-penalty, Striker, Swap, leftover-walk, Death Realm skip, dump-alcove, live-gate, or RAF. Do not open another Striker / mapGen / persist / combat-parity / expansion / AI PR while #327 / #331 / #333–#608 exist. Dashboard specialist: skip UI (AQA-012).  
...
ACTION_ID: MTD-2026-09-26-002  
SOURCE_AUTOMATION: Stralt Master Technical Director  
TITLE: Supersede unmerged director PRs #338, #402, #448, #509, and #569; keep one living roadmap on main  
CATEGORY: process  
PRIORITY: P0  
CONFIDENCE: HIGH  
EVIDENCE: 09-21 wrote living files on #338. 09-22 on #402. 09-23 on #448. 09-24 on #509. 09-25 on #569. None merged. `main` still serves the 2026-09-02 roadmap, so 09-21 through 09-26 flocks planned against a stale index. Six open director PRs on the same files fail oldest-first stack-compat.  
SYSTEMS_AFFECTED: `docs/automation/MASTER_ROADMAP.md`; director ACTION_ID files; merge queue  
RECOMMENDED_ACTION: Close #338, #402, #448, #509, and #569 without merge (this PR subsumes all five snapshots plus the 09-26 delta). Do not merge all six. Future director runs write `ACTION_IDS_YYYY-MM-DD.md` and replace the living `MASTER_ROADMAP.md`.  
AUTONOMY: HUMAN_REVIEW  
DEPENDENCIES: MTD-2026-09-25-002  
REGRESSION_RISK: LOW — docs only; 09-21…09-25 facts are copied forward  
VALIDATION_REQUIRED: After merge, `main` `MASTER_ROADMAP.md` header date is this run; #338, #402, #448, #509, and #569 are closed.  
STATUS: NEW  

---

ACTION_ID: MTD-2026-09-26-003  
SOURCE_AUTOMATION: Stralt Master Technical Director  
TITLE: Triage the 279-draft leftover queue; do not merge-burst it  
CATEGORY: automation-coherence  
PRIORITY: P0  
CONFIDENCE: HIGH  
EVIDENCE: `gh pr list --state open` = **279**, all draft. Leftover **#327** + **#331**, then **#333–#555**, then **#556–#608** (09-25), then **#609** (09-26 TBC). Gameplay includes **twenty** mapGen punches, persist skip-wipe cluster, Death Realm skip mill, two Striker PRs, leftover-walk mill, Swap local patch #541, combat live-gate mill, AdminDashboard chrome, feel/UX/a11y, and **#501 RAF**. 09-02 proved humans will merge this shape if it sits in the button.  
SYSTEMS_AFFECTED: GitHub merge queue; WX; mapGen; persist lock; AdminDashboard; RAF  
RECOMMENDED_ACTION: Ordered unique leftovers only (see MASTER_ROADMAP human merge queue). Close or hold duplicates. Docs catalogs may land **after** P0/P1 if they do not rewrite schemas or retune BAL-*. Do not sequential-merge 270+ gameplay drafts to “clear the queue.”  
AUTONOMY: HUMAN_REVIEW  
DEPENDENCIES: MTD-2026-09-26-001; MTD-2026-09-25-003  
...
ACTION_ID: MTD-2026-09-26-004  
SOURCE_AUTOMATION: Stralt Master Technical Director  
TITLE: Hold the 09-25 dump-alcove / Death Realm skip / live-gate / skip-wipe clone mill  
CATEGORY: sensitive-code  
PRIORITY: P1  
CONFIDENCE: HIGH  
EVIDENCE: After the 09-25 director named sixteen mapGen punches as HOLD, the same day opened dump-alcove **#589 / #600 / #603 / #608**. Persist hunters opened skip-wipe twins **#580 / #599** on top of #330’s keep. A new Death Realm pending mill opened **#576 / #595 / #602 / #604** (heal / Items / rename+upgrade / feat+GameKey). Combat parity opened live-gate / live-pool **#562 / #581 / #596 / #597 / #598 / #601 / #607** plus leftover-walk **#606**. Local patches on these subsystems are no longer sufficient. Combat parity / expansion are RUNNING again tonight.  
SYSTEMS_AFFECTED: `mapGen.ts`; `progressPersist.ts` callers; `WorldExploration.tsx`; combat helpers; death guards; RAF  
RECOMMENDED_ACTION: HOLD all listed clones. Guardian / persist / combat-parity / economy automations = ACTION_IDs + failing fixtures only until a human authorizes one helper each (`shouldPunchPortalNeighbor`, unseeded-HUD adopt, `applyHazardLanding`, leftover-walk cancel, `shouldBlockWhileDeathPending`, shared live-pool). Do not sequential-merge twins. Do not land #501 or #541.  
AUTONOMY: HUMAN_CONFIG + review  
DEPENDENCIES: AQA-2026-08-30-006; AQA-2026-08-30-007; AQA-2026-08-30-010; MTD-2026-09-25-004  
REGRESSION_RISK: HIGH if another punch/keep/WX/RAF/Swap/death-skip branch lands without playtest  
VALIDATION_REQUIRED: Next director run opens 0 new mapGen / persist-HUD / leftover-walk WX / RAF / Swap / Death Realm skip / dump-alcove PRs from those automations.  
STATUS: NEW  
...
PRIORITY: P0  
CONFIDENCE: HIGH  
EVIDENCE: Reused. Queue head is leftover **#327** (`createdAt` 2026-09-02 16:23, now **24 days** stale, `mergeable: CONFLICTING`, 20 files / +1371). Oldest-first (`scripts/open-pr-stack-compat.sh`) requires that PR before later docs, including this living roadmap. Eight director runs (09-21…09-26 plus 09-02 on `main`) could not land the index. Six director PRs on the same living files already conflict with each other. ENGINEERING: this is why `main` still serves the 09-02 roadmap. Queue grew 230 → **279**.  
SYSTEMS_AFFECTED: merge queue; `docs/automation/MASTER_ROADMAP.md`; leftover #327; every later automation PR  
RECOMMENDED_ACTION: Human: (1) close superseded director snapshots #338/#402/#448/#509/#569 without merge; (2) restack #327 onto current `origin/main` **or** close it if a human will re-author the Striker helper after halt; (3) do not treat “merge 270 drafts to unblock the button” as the fix. Docs-only director PRs should not wait behind a dirty 20-file gameplay PR.  
AUTONOMY: HUMAN_REVIEW  
DEPENDENCIES: MTD-2026-09-21-003; MTD-2026-09-26-002; MTD-2026-09-26-003  
...
PRIORITY: P0  
CONFIDENCE: HIGH  
EVIDENCE: Reused. Reconfirmed 2026-09-26: source chain unchanged (`20260831` frozen without GameKey; `20260901` adds GameKey with `OldActor = {}`; `check-limit = 5`). `snapshots/deployed/` still four files; newest GameKey shape is `pr259-tail-20260901.most`. No post-#324 refresh. **23 days** of zero `main` commits after #332. ENGINEERING: import of HEAD vs Aug-31 `.old` should now pass. Ops: this run cannot see Caffeine’s private copy.  
...
PRIORITY: P1  
CONFIDENCE: HIGH  
EVIDENCE: Reused. Oldest open PR (`createdAt` 2026-09-02 16:23). Still draft, now **24 days** stale, `mergeable: CONFLICTING` vs `0f5363f`. Unique on `main`: legendary_3 consulted only the aim tile. **#370** is a later **superset**. Also the oldest-first queue head (MTD-2026-09-25-005).  
...
PRIORITY: P1  
CONFIDENCE: HIGH  
EVIDENCE: Reused. #370 title still “fail Striker when AoE, bounce, or AI kit-cast lands beyond 2 tiles.” #327 already owns splash/bounce. Duplicate `export function` in one file fails Caffeine `vite build`.  
...
PRIORITY: P1  
CONFIDENCE: HIGH  
EVIDENCE: Reused, worse. `mapGen.ts` still **1,937**. Drafts now **twenty**: prior sixteen plus dump-alcove **#589 #600 #603 #608**. Guardian `9dcfd122` still enabled. `AGENTS.md` still forbids map-generation edits. Local patches are no longer sufficient.  
SYSTEMS_AFFECTED: `src/frontend/src/engine/mapGen.ts`; battle-start destack; portals  
RECOMMENDED_ACTION: HOLD all twenty. Guardian = failing seed fixtures + ACTION_IDs only. When a human authorizes: one helper (`shouldPunchPortalNeighbor` / stay-on battle component) + the #321/#329/#331 seeds as tests. Do not rewrite cellular automata. Do not auto-refactor this hour.  
AUTONOMY: HUMAN_CONFIG + IMPLEMENT_AFTER_HUMAN  
DEPENDENCIES: AQA-2026-08-30-006; MTD-2026-09-26-004  
...
PRIORITY: P0  
CONFIDENCE: HIGH  
EVIDENCE: Reused. Volume problem is combat/persist/admin/economy/map/expansion implementers, not a missing hunter. `1aa41c6c` remains enabled.  
...
PRIORITY: P1  
CONFIDENCE: HIGH  
EVIDENCE: Reused. See MTD-2026-09-21-004 / MTD-2026-09-26-004. Twenty open mapGen PRs. Guardian `9dcfd122` still enabled.  
SYSTEMS_AFFECTED: `src/frontend/src/engine/mapGen.ts`  
RECOMMENDED_ACTION: Report-only unless a human authorizes a playtested helper. Close or hold any 09-21…09-26 mapGen PR.  
AUTONOMY: HUMAN_CONFIG  
...
PRIORITY: P1  
CONFIDENCE: HIGH  
EVIDENCE: Reused. File is 19,213 lines. Combat parity `f37b7505` is enabled and RUNNING tonight. Open WX-touching drafts include the leftover-walk mill, live-gate mill, Death Realm skip mill, Swap #541, and #501 RAF.  
...
PRIORITY: P1  
CONFIDENCE: HIGH  
EVIDENCE: Reused. Reconfirmed on `0f5363f`. `swapPositions` (`WorldExploration.tsx` 9389–9402) still copies coordinates and does not call `applyBattleWalkHazards`. Glob `applyHazardLanding` = 0 files. Occupancy helper exists for summons; Swap does not use it. **#541** remains a later local Swap patch — HOLD.  
...
DEPENDENCIES: AQA-2026-08-30-007; MTD-2026-09-26-001  
...
PRIORITY: P1  
CONFIDENCE: HIGH  
EVIDENCE: Reused. Reconfirmed: `gameKeyUnpaidDeath` is **not** on `main`. **#391** drafts the helper in a **new file** and explicitly does not edit `shopPurchase.ts`. Helper is the right shape; wiring is still open.  
SYSTEMS_AFFECTED: GameKey shop; death penalty; persist lock; HUD wallet  
RECOMMENDED_ACTION: After flock halt: merge #391 (helper + tests) **or** restack the helper onto a quiet `shopPurchase.ts`, then one import at the redeem commit. Do not recut a `cutConfirmed` wallet. Do not change redeem canister math. Do not sequential-merge Death Realm skip mill (#604) as a substitute.  
...
PRIORITY: P2  
CONFIDENCE: HIGH  
EVIDENCE: Reused. Reconfirmed on `0f5363f`. `buildEnemyKit` (`enemyAI.ts` 194–199) takes `levelZone: number`. Call site `WX` 11920 still passes `currentMap.levelZone`. `setCurrentZoneTier(playerTier + 1)` already stores the number (`WX` 1136 / 4680). `Math.floor(object)` is `NaN` → zone-0 forever. Survived **eight** director cycles.  
...
AUTONOMY: IMPLEMENT_AFTER_HUMAN  
DEPENDENCIES: MTD-2026-09-26-001; AQA-2026-08-30-007  
...
PRIORITY: P2  
CONFIDENCE: HIGH  
EVIDENCE: Reused. `shouldIncludeBackendSpellInLibrary` (`adminSafety.ts` 712–718) returns true whenever `usableByPlayer !== false`. No `ownedSpellIds` / observe path. 09-21…09-26 produced more overlapping discovery catalogs — content cards, not a persist shape.  
...
PRIORITY: P2  
CONFIDENCE: HIGH  
EVIDENCE: Reused. Still no collectors on `0f5363f` (`src/` grep `recordTelemetry` = 0). TBC correctly WAITING this hour (#609). Telemetry dashboard specialist is RUNNING tonight — skip UI. Telemetry increment maps would be new stables — blocked on MTD-2026-09-02-003.  
...
PRIORITY: P2  
CONFIDENCE: HIGH  
EVIDENCE: Reused. Fresh search this run: 0 `recordTelemetry` hits in `src/`. TBC agent `2786666f` opened [#609](https://github.com/Mr-Melic/stralt/pull/609) WAITING_FOR_TELEMETRY — correct.  
SYSTEMS_AFFECTED: Telemetry-Driven Balance automation  
RECOMMENDED_ACTION: STATUS WAITING_FOR_TELEMETRY. No BAL-* implementation. Write TBC ACTION_IDs to `ACTION_IDS_TBC_YYYY-MM-DD.md`, not the director file. Keep one TBC dated report; later twins (#395/#462/#502/#556/#609) do not need sequential merge.  
AUTONOMY: HUMAN_CONFIG  
...
PRIORITY: P1  
CONFIDENCE: HIGH  
EVIDENCE: Reused, worse. 09-21…09-25 catalog PRs plus tonight’s expansion `3f31b18f` (RUNNING), AI `67b03c2f` (enabled), world mechanics, enemy formations. `fe5b679a` not GetAutomation-visible. That is expansion overlap, not a license to implement.  
...
AUTONOMY: HUMAN_CONFIG  
DEPENDENCIES: MTD-2026-09-26-001; MTD-2026-09-21-002  
REGRESSION_RISK: LOW  
VALIDATION_REQUIRED: No SDA/SDE/EBA/AI/expansion gameplay PR from the 09-26 wave.  
STATUS: OPEN  
...
PRIORITY: P0  
CONFIDENCE: HIGH  
EVIDENCE: Reused. `ACTION_IDS_2026-09-01.md` remains concatenated. 09-02 director file stayed clean. 09-21…09-25 director files exist only on #338/#402/#448/#509/#569. This run writes `ACTION_IDS_2026-09-26.md` only and does not append to those files.  
SYSTEMS_AFFECTED: `docs/automation/ACTION_IDS_*.md`  
RECOMMENDED_ACTION: Each producer writes `ACTION_IDS_<PREFIX>_YYYY-MM-DD.md`. Director maintains MASTER_ROADMAP + `ACTION_IDS_YYYY-MM-DD.md` (director IDs only). TBC must not write into the director file. Do not append to 08-31, 09-01, 09-02, or 09-21 through 09-25.  
AUTONOMY: HUMAN_CONFIG  
DEPENDENCIES: AQA-2026-08-30-003  
REGRESSION_RISK: LOW  
VALIDATION_REQUIRED: Next wave adds 0 lines to ACTION_IDS_2026-08-31.md, ACTION_IDS_2026-09-01.md, ACTION_IDS_2026-09-02.md, and ACTION_IDS_2026-09-21.md through ACTION_IDS_2026-09-25.md.  
STATUS: OPEN  
