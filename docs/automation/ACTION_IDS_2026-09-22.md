# ACTION_IDs — 2026-09-22 Master Technical Director
...
**Prior director:** unmerged [`#338`](https://github.com/Mr-Melic/stralt/pull/338) + memories (`bc-0f5c19f1-d985-4d12-a388-d14eb6fe8935`). On `main`, [`MASTER_ROADMAP.md`](./MASTER_ROADMAP.md) is still the 2026-09-02 text.  
**This agent:** `bc-6bace305-7113-4264-bdea-2cd083c125fc`  
**Gameplay / production code:** not modified this run.

Specialist IDs stay in their producer files. Do not concatenate into this ledger. Do not append to `ACTION_IDS_2026-08-31.md`, `ACTION_IDS_2026-09-01.md`, `ACTION_IDS_2026-09-02.md`, or `ACTION_IDS_2026-09-21.md` (the last exists only on #338, not on `main`).
...
| :--- | :--- | :--- |
| MTD-2026-08-31-001 / MTD-2026-09-01-001 | OPEN | Halt-as-config failed 08-31, 09-01, 09-02, 09-21, **09-22**. Halt-as-merge-stop held for 19 days (`main` still `0f5363f`). |
| MTD-2026-09-21-001 | PARTIAL | 09-21 wave opened **59** drafts (#333–#391). Humans **did not merge** them. Validation “≤3 gameplay PRs” **failed**. See MTD-2026-09-22-001 / 003. |
...
| MTD-2026-09-02-004 / AQA-2026-08-30-003 | PARTIAL | 09-02 file stayed clean. #338’s 09-21 ledger never landed on `main`. This run writes `ACTION_IDS_2026-09-22.md` only. |
| MTD-2026-09-21-003 | OPEN | **#327 still open** (oldest draft, 20 days stale). #370 is a later Striker **superset** — do not merge both. |
| MTD-2026-09-21-004 | OPEN | #331 still open. 09-21 added **#373 / #378 / #383** (more mapGen portal-graph punches). Hold all four. |
| AQA-2026-08-30-008 | PARTIAL | Clamps + ignore-client level + AP/MP cap; **no ADR** (`docs/**/*ADR*` = 0). |
| AQA-2026-08-30-006 | BROKEN | mapGen still **1,937**. Four open punch PRs. Guardian still enabled. |
| AQA-2026-08-30-007 | BROKEN | WX still **19,213**. 227 commits since 08-24. 09-21 wave opened more WX drafts. Combat parity is RUNNING again tonight. |
| AQA-2026-08-30-005 | PARTIAL | Test mill still firing (#358 / #381 / #390). |
| AQA-2026-08-30-012 | OPEN | Still 0 collectors. TBC #333 WAITING docs. Dashboard #345 is design-only. |
| TBC-2026-08-31-001 | OPEN | WAITING_FOR_TELEMETRY. Confirmed this run. TBC is RUNNING again tonight (`2786666f`). |
...
| MIMA-2026-09-01-002 | PARTIAL | Barriers in `isBattleWalkTileBlocked`. Occupants still missing (`walkRejectCopy.ts` 21–34). |
| MIMA-2026-09-02-001 | IMPLEMENTED | #318 `enemyWalkMp.ts`. |
| MIMA-2026-09-02-003 | OPEN (helper drafted) | `redeemGameKeyThroughPersist` (`shopPurchase.ts` 294–331) still raw lock+grant. **#391** adds `gameKeyUnpaidDeath.ts` + tests, **does not wire** the redeem path (correct while persist PRs own `shopPurchase.ts`). |
| PXA-2026-09-02-002 | IMPLEMENTED | #332 accepted-challenge HUD. #364 (HUD steal clicks) is a leftover P3 — hold this hour. |
...
| MTD-2026-08-31-004 | OPEN | Expansion freeze. 09-21 dropped another overlapping catalog wave. 09-22 designers already RUNNING. |
...
| RAO-2026-09-03-0000-003 | NEEDS_HUMAN_DECISION | Paper Windstorm two live rates. Repeated by RAO 09-21 18:00. Do not “fix” announce alone. |
...
PRIORITY: P0  
CONFIDENCE: HIGH  
EVIDENCE: Failed 2026-08-31, 09-01, 09-02 (humans then merged). Halt-as-merge-stop then held **19 days** (`main` still `0f5363f`). Recurred 2026-09-21: **59** open drafts (#333–#391) in one calendar day (00:00 plus 06/08/12/15/16/18 crons). Recurred **2026-09-22 00:00**: already RUNNING include combat parity `f37b7505`, persist/data-evolution `469b7020`, admin dashboard `b1bc1d63`, admin regression `67820d12`, performance `4191af8a`, plus designers (spell admin, enemy/boss admin, PX, world dynamics, dungeon encounters, TBC). `1aa41c6c` still **enabled**. `fe5b679a` (Approved Game Design Implementer) still **enabled**. `386a157d` (complexity) still **enabled**. `996df6df` still not GetAutomation-visible. Cursor has no dashboard write API.  
SYSTEMS_AFFECTED: all implementer automations; 61-draft merge queue; live Caffeine upgrade  
RECOMMENDED_ACTION: First-run and expansion specialists emit ACTION_IDs only. Do not open gameplay PRs this cycle unless unique, display-only, and not already drafted yesterday. Stagger crons. Pause map/combat/persist/Motoko-stables implementers after a freeze restart, not only after a merge burst. Keep one critical hunter. Disable or pause `fe5b679a` until P0/P1 are closed.  
AUTONOMY: HUMAN_CONFIG  
DEPENDENCIES: AQA-2026-08-30-001; AQA-2026-08-30-009  
REGRESSION_RISK: LOW  
VALIDATION_REQUIRED: Next director run sees ≤3 **new** gameplay PRs from the 09-22 wave, and those PRs do not retouch persist / targeting / mapGen / WX / `main.mo` stables. The 09-21 leftover queue is not merge-bursted.  
STATUS: OPEN  

---

ACTION_ID: MTD-2026-09-22-001  
SOURCE_AUTOMATION: Stralt Master Technical Director  
TITLE: Hold the 2026-09-22 00:00 specialist wave  
CATEGORY: automation-coherence  
PRIORITY: P0  
CONFIDENCE: HIGH  
EVIDENCE: Same HEAD as 09-21. P0 leftovers (Caffeine deploy, ADR, #327 restack) still open. 65+ drafts already in the queue. This hour already launched combat-parity and persist implementers. First 09-22 PRs (#392–#395) are docs-only — keep it that way.  
SYSTEMS_AFFECTED: merge queue; `WorldExploration.tsx`; `mapGen.ts`; `main.mo`; AdminDashboard; migrations  
RECOMMENDED_ACTION: Default HOLD any PR from this wave. Designers update their own dated files; do not rewrite SDA/SDE/EBA schemas; do not restack GameKey, Frozen MP, spawnPolicy, death-penalty, or Striker. Do not open a second Striker / mapGen / persist PR while #327 / #331 / #356–#391 exist.  
...
ACTION_ID: MTD-2026-09-22-002  
SOURCE_AUTOMATION: Stralt Master Technical Director  
TITLE: Supersede unmerged director PR #338; keep one living roadmap on main  
CATEGORY: process  
PRIORITY: P0  
CONFIDENCE: HIGH  
EVIDENCE: 09-21 director wrote `MASTER_ROADMAP.md` + `ACTION_IDS_2026-09-21.md` on #338 (`createdAt` 2026-09-21 00:11). It never merged. `main` still serves the 2026-09-02 roadmap, so the 09-21/09-22 flocks planned against a stale index. Two open director PRs on the same files will fail oldest-first stack-compat.  
SYSTEMS_AFFECTED: `docs/automation/MASTER_ROADMAP.md`; director ACTION_ID files; merge queue  
RECOMMENDED_ACTION: Close #338 without merge (this PR subsumes the 09-21 snapshot plus the 09-22 delta). Do not merge both. Future director runs write `ACTION_IDS_YYYY-MM-DD.md` and replace the living `MASTER_ROADMAP.md`.  
AUTONOMY: HUMAN_REVIEW  
DEPENDENCIES: none  
REGRESSION_RISK: LOW — docs only; 09-21 facts are copied forward  
VALIDATION_REQUIRED: After merge, `main` `MASTER_ROADMAP.md` header date is this run; #338 is closed.  
STATUS: NEW  

---

ACTION_ID: MTD-2026-09-22-003  
SOURCE_AUTOMATION: Stralt Master Technical Director  
TITLE: Triage the 59-draft 09-21 leftover queue; do not merge-burst it  
CATEGORY: automation-coherence  
PRIORITY: P0  
CONFIDENCE: HIGH  
EVIDENCE: Open drafts on this HEAD: leftover **#327** + **#331**, then **#333–#391** (59). ~23 are docs-only catalogs (another overlapping SDA/SDE/EBA/AI/formations/world/boss/visual/telemetry wave). ~36 are gameplay/admin/test/perf, including four mapGen punches, a persist cluster (#356/#362/#375/#377/#385/#387/#388/#391), two Striker PRs (#327/#370), combat-parity WX (#340/#379/#389), AdminDashboard (#334/#341), and feel/UX/a11y. 09-02 proved humans will merge this shape if it sits in the button.  
SYSTEMS_AFFECTED: GitHub merge queue; WX; mapGen; persist lock; AdminDashboard  
RECOMMENDED_ACTION: Ordered unique leftovers only (see MASTER_ROADMAP human merge queue). Close or hold duplicates. Docs catalogs may land **after** P0/P1 if they do not rewrite schemas or retune BAL-*. Do not sequential-merge 36 gameplay drafts to “clear the queue.”  
AUTONOMY: HUMAN_REVIEW  
DEPENDENCIES: MTD-2026-09-22-001  
...
PRIORITY: P0  
CONFIDENCE: HIGH  
EVIDENCE: Reused. Reconfirmed 2026-09-22: source chain unchanged (`20260831` frozen without GameKey; `20260901` adds GameKey with `OldActor = {}`; `check-limit = 5`). `snapshots/deployed/` still four files; newest GameKey shape is `pr259-tail-20260901.most`. No post-#324 refresh. 19 days of zero `main` commits after #324. ENGINEERING: import of HEAD vs Aug-31 `.old` should now pass. Ops: this run cannot see Caffeine’s private copy.  
...
PRIORITY: P0  
CONFIDENCE: HIGH  
EVIDENCE: Reused. Frozen chain files on `main` unchanged. #362 (`saveActiveSpells` keep-store + unbounded GameKey serial) is behavior-only — still HOLD until flock triage, but it is **not** a stuffed NewActor. Discovery / telemetry / admin lifecycle maps would be new stables. Tonight’s flock includes persist (`469b7020`) again.  
...
PRIORITY: P0  
CONFIDENCE: HIGH  
EVIDENCE: Reused. Clamp/no-mint is on `main`. `writeLevel` always `character.level`. #322 caps AP/MP. Glob `docs/**/*ADR*` = 0. Finding 3 is still restated as “must not write Doka.” Security `c97e5c0c` opened #368 (changelog bind + https ads) — unique, not the ADR.  
SYSTEMS_AFFECTED: `src/backend/main.mo`; `docs/ARCHITECTURE.md`  
RECOMMENDED_ACTION: Write the ADR: (a) official-client trust + store-relative clamps (current de-facto), or (b) canister proofs. Rewrite finding 3. Do not open a fourth clamp PR. Do not revert GameKey.  
...
PRIORITY: P1  
CONFIDENCE: HIGH  
EVIDENCE: Reused. Oldest open PR (`createdAt` 2026-09-02 16:23). Still draft, now **20 days** stale. Unique on `main`: legendary_3 consulted only the aim tile. **#370** (09-21 00:31) is a later **superset**: same splash/bounce helper plus AI kit-cast / summon `onSpentCast`. Do not merge both as two WX restacks.  
...
PRIORITY: P1  
CONFIDENCE: HIGH  
EVIDENCE: #370 title “fail Striker when AoE, bounce, or AI kit-cast lands beyond 2 tiles.” Files: WX + `challengeCompletion.ts` + `castHelpers.ts` + `summonExecutor.ts`. #327 already owns splash/bounce. Duplicate `applyChallengeDirectHitOnCast` in one file fails Caffeine `vite build`.  
...
PRIORITY: P1  
CONFIDENCE: HIGH  
EVIDENCE: Reused, worse. `mapGen.ts` still **1,937**. Drafts now: **#331** (parallel corridor), **#373** (destack around portal choke), **#378** (dump cells on battle graph), **#383** (relocate corpses/summons on fight graph). Four local punches on the same hotspot in one day after an 18-day freeze. Guardian still enabled. `AGENTS.md` still forbids map-generation edits. Local patches are no longer sufficient.  
SYSTEMS_AFFECTED: `src/frontend/src/engine/mapGen.ts`; battle-start destack; portals  
RECOMMENDED_ACTION: HOLD #331 / #373 / #378 / #383. Guardian = failing seed fixtures + ACTION_IDs only. When a human authorizes: one helper (`shouldPunchPortalNeighbor` / stay-on battle component) + the #321/#329/#331/#373 seeds as tests. Do not rewrite cellular automata. Do not auto-refactor this hour.  
...
PRIORITY: P0  
CONFIDENCE: HIGH  
EVIDENCE: Reused. `996df6df-9d7a-11f1-a7d1-d6b4613131ce` still not GetAutomation-visible (confirmed this run). WX is 19,213 lines / 227 commits since 2026-08-24. 09-21 leftover gameplay drafts already cover yesterday’s unique defects.  
...
PRIORITY: P0  
CONFIDENCE: HIGH  
EVIDENCE: Reused. `1aa41c6c-a483-11f1-a7d1-d6b4613131ce` remains **enabled** (GetAutomation this run). Volume problem is this hunter plus combat/persist/admin/economy implementers, not a missing hunter.  
...
PRIORITY: P1  
CONFIDENCE: HIGH  
EVIDENCE: Reused. See MTD-2026-09-21-004. Four open mapGen PRs. Guardian `9dcfd122` still enabled (confirmed this run).  
SYSTEMS_AFFECTED: `src/frontend/src/engine/mapGen.ts`  
RECOMMENDED_ACTION: Report-only unless a human authorizes a playtested helper. Close or hold any 09-21/09-22 mapGen PR.  
AUTONOMY: HUMAN_CONFIG  
...
PRIORITY: P1  
CONFIDENCE: HIGH  
EVIDENCE: Reused. File is 19,213 lines. Combat parity `f37b7505` is RUNNING tonight and already opened #340/#379/#389 yesterday.  
...
DEPENDENCIES: AQA-2026-08-30-007; MTD-2026-09-22-001  
...
PRIORITY: P1  
CONFIDENCE: HIGH  
EVIDENCE: Reused. Reconfirmed: `redeemGameKeyThroughPersist` (`shopPurchase.ts` 294–331) enqueue → `redeemGameKey` → `committedDokaAfterGameKeyRedeem`. No `applyUnpaidDeathPenaltyToWrite`. **#391** drafts `committedDokaAfterGameKeyUnpaidDeath` in a **new file** and explicitly does not edit `shopPurchase.ts` while older persist PRs own it. Helper is the right shape; wiring is still open.  
...
DEPENDENCIES: Do not clone EOP. Reuse `applyUnpaidDeathPenaltyToWrite`. Hold #377 (also owns `shopPurchase.ts`) until unioned.  
...
PRIORITY: P2  
CONFIDENCE: HIGH  
EVIDENCE: Reused. Reconfirmed on `0f5363f`. `buildEnemyKit` (`enemyAI.ts` 194–199) takes `levelZone: number`. Call site `WX` 11920 still passes `currentMap.levelZone`. `setCurrentZoneTier(playerTier + 1)` already stores the number (`WX` 4678–4680). `Math.floor(object)` is `NaN` → zone-0 forever. Survived **four** director cycles.  
...
AUTONOMY: IMPLEMENT_AFTER_HUMAN  
DEPENDENCIES: MTD-2026-09-22-001; AQA-2026-08-30-007  
...
PRIORITY: P2  
CONFIDENCE: HIGH  
EVIDENCE: Reused. `shouldIncludeBackendSpellInLibrary` (`adminSafety.ts` 712–718) returns true whenever `usableByPlayer !== false`. `ownedSpells` is still starters ∪ filtered backend (`WX` 2412+). No `ownedSpellIds` / observe path. 09-21 produced another overlapping discovery catalog (#353 / #371) — content cards, not a persist shape.  
...
PRIORITY: P2  
CONFIDENCE: HIGH  
EVIDENCE: Reused. Still no collectors on `0f5363f` (`src/backend` grep `recordTelemetry` = 0). TBC #333 WAITING. Dashboard #345 / architecture #352 are design-only. TBC `2786666f` is RUNNING tonight. Telemetry increment maps would be new stables — blocked on MTD-2026-09-02-003.  
...
PRIORITY: P2  
CONFIDENCE: HIGH  
EVIDENCE: Reused. Fresh search this run: 0 `recordTelemetry` hits in `src/backend`. `longHorizonSim.telemetry.available === false`. TBC automation `2786666f` is RUNNING tonight — it must stay WAITING_FOR_TELEMETRY.  
...
PRIORITY: P1  
CONFIDENCE: HIGH  
EVIDENCE: Reused. 09-21 catalog PRs: #342/#347/#348/#349/#351/#353/#355/#359/#360/#365/#366/#367/#371. That is expansion overlap, not a license to implement. 09-22 already relaunched enemy/boss admin, spell admin, dungeon encounters, world mechanics, PX. `fe5b679a` still enabled.  
...
AUTONOMY: HUMAN_CONFIG  
DEPENDENCIES: MTD-2026-09-22-001; MTD-2026-09-21-002  
REGRESSION_RISK: LOW  
VALIDATION_REQUIRED: No SDA/SDE/EBA/AI gameplay PR from the 09-22 wave.  
STATUS: OPEN  
...
PRIORITY: P0  
CONFIDENCE: HIGH  
EVIDENCE: Reused. `ACTION_IDS_2026-09-01.md` remains concatenated. 09-02 director file stayed clean. 09-21 director file exists only on #338. This run writes `ACTION_IDS_2026-09-22.md` only.  
SYSTEMS_AFFECTED: `docs/automation/ACTION_IDS_*.md`  
RECOMMENDED_ACTION: Each producer writes `ACTION_IDS_<PREFIX>_YYYY-MM-DD.md`. Director maintains MASTER_ROADMAP + `ACTION_IDS_YYYY-MM-DD.md` (director IDs only). TBC must not write into the director file. Do not append to 08-31, 09-01, 09-02, or 09-21.  
AUTONOMY: HUMAN_CONFIG  
