...
- WorldExploration `attributeKillReward` / `selectDefeatedEnemiesForRewards`: player-summon deaths (bomber, enemy melee, DoT) were appended to the victory roster, so `applyRewards` credited extra XP/Doka. PR: (this run). Status: open. Recorded: 2026-08-30.
