...
| `src/frontend/src/utils/startingChampionStats.ts` | Official 12-field create defaults (`createCharacter` rejects higher; `_starterCharacter` strips session/spell fields) |
...
| [docs/automation/ACTION_IDS_2026-09-22.md](docs/automation/ACTION_IDS_2026-09-22.md) | Current director ACTION_ID ledger (2026-09-22) |
| [docs/automation/ACTION_IDS_2026-09-21.md](docs/automation/ACTION_IDS_2026-09-21.md) | Prior director ACTION_ID ledger (2026-09-21; also on #338) — do not append |
...
| [docs/automation/TELEMETRY_DASHBOARD_2026-09-21.md](docs/automation/TELEMETRY_DASHBOARD_2026-09-21.md) | Current owner Health dashboard support matrix (design only; refresh after GameKey redeem helper + Boss Rush run-count) |
| [docs/automation/ACTION_IDS_TADD_2026-09-21.md](docs/automation/ACTION_IDS_TADD_2026-09-21.md) | Telemetry dashboard designer ACTION_IDs (2026-09-21) |
| [docs/automation/TELEMETRY_DASHBOARD_2026-09-02.md](docs/automation/TELEMETRY_DASHBOARD_2026-09-02.md) | Prior owner Health dashboard support matrix (GameKey + audit bindgen; stale shop-credit dual-path) |
...
| [docs/automation/TELEMETRY_ARCHITECTURE_2026-09-02.md](docs/automation/TELEMETRY_ARCHITECTURE_2026-09-02.md) | Current owner-facing aggregate telemetry design (no production instrumentation) |
| [docs/automation/TELEMETRY_ARCHITECTURE_2026-09-01.md](docs/automation/TELEMETRY_ARCHITECTURE_2026-09-01.md) | Prior owner-facing aggregate telemetry design (stale line numbers / shop path) |
...
| [docs/design/ENEMY_FORMATIONS_2026-09-02.md](docs/design/ENEMY_FORMATIONS_2026-09-02.md) | Proposed enemy synergy packs drop 3 (design only) |
