...
// Returns true when the condition can no longer be satisfied this battle,
// i.e. the challenge is already failed (banner chip should flip to ✗).
// "under_N_turns" challenges are only failed at battle end (turn count is
// final only on victory), so they report false mid-battle.
