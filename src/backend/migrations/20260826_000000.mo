  ...
  public func migration(_old : OldActor) : NewActor {
    {
      ...
      characterSlots = Map.empty<Principal, CharacterSlots>();
      enemyConfigs = Map.empty<Text, EnemyConfig>();
      regionConfigs = Map.empty<Text, RegionConfig>();
      playerSpriteConfigs = Map.empty<Text, PlayerSpriteConfig>();
      var levelUpConfig = emptyLevelUp;
      spellConfigs = Map.empty<Text, SpellConfig>();
      mapModifierConfigs = Map.empty<Text, MapModifierConfig>();
      roleChangeTimestamps = Map.empty<Text, Int>();
      shopPackages = Map.empty<Text, ShopPackage>();
      achievementConfigs = Map.empty<Text, AchievementConfig>();
      achievementProgress = Map.empty<Text, AchievementProgress>();
      purchaseRecords = Map.empty<Text, PurchaseRecord>();
      var nextPurchaseId = 0;
      bannedPrincipals = Map.empty<Text, Bool>();
      var gameConfig = emptyGame;
      var tierSpawnConfig = emptyTierSpawn;
      var colorPaletteStore = "";
      var bossRushConfigStore = "";
      var appVersion = "";
      changelogs = Map.empty<Text, Text>();
      changelogShownVersions = Map.empty<Principal, Text>();
      buffInventories = Map.empty<Text, BuffInventory>();
      dungeonRecords = Map.empty<Principal, DungeonRecord>();
      bossConfigs = Map.empty<Text, BossConfig>();
      bossPortalAssignments = Map.empty<Text, Text>();
      dokaBalances = Map.empty<Principal, Nat>();
      bossRushStates = Map.empty<Text, BossRushState>();
      var enemyNames = List.empty<Text>();
